...
import 'package:mytal/view/screens/doctor_dashboard_screen.dart';
...
class DoctorMain extends StatefulWidget {
  ...
  const DoctorMain({Key? key, this.initialIndex = 0}) : super(key: key);

  @override
  DoctorMainState createState() => DoctorMainState();
}

class DoctorMainState extends State<DoctorMain> {
  int _selectedIndex = 0;
  String _selectedTitle = "Patients";
